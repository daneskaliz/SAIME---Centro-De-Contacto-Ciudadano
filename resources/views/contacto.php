  ...
  <div class="container contenido1 bg-light pb-5">
    ...
    <div class="row">
        ...
        <div class="row">
          <div class="col-4">
            <a href="https://twitter.com/redsocialsaime">
              <img src="../../assets/img/twitter-icon.png" class="ml-5" width="90"
                height="90" alt="">
            </a>
          </div>
          <div class="col-8">
        ...
        <div class="row">
          <div class="col-4">
            <a href="http://www.saime.gob.ve">
              <img src="../../assets/img/web.png" class="ml-5 my-2" width="90"
                height="85" alt="">
            </a>
          </div>
          <div class="col-8">
        ...
        <div class="row">
          <div class="col-4">
            <a href="https://www.facebook.com/SomosRedSaime/">
              <img src="../../assets/img/facebook-icon.png" class="ml-5 my-3" width="90"
                height="90" alt="">
            </a>
          </div>
          <div class="col-8">
      ...
      <div class="col-sm-12 col-md-6">
        <div class="row">
          <div class="col-4">
            <img src="../../assets/img/mail.png" class="ml-5 my-4" width="90"
              height="85" alt="">
          </div>
          <div class="col-8">
            <div class="row mt-5">
        ...
        <div class="row">
          <div class="col-4">
            <a href="https://www.instagram.com/redsocialsaime/">
              <img src="../../assets/img/instagram.svg" class="ml-5 my-3" width="90"
                height="90" alt="">
            </a>
          </div>
          <div class="col-8">
        ...
        <div class="row">
          <div class="col-4">
            <a href="https://www.youtube.com/user/ImagenSaime">
              <img src="../../assets/img/youtube.png" class="ml-5" width="90"
                height="90" alt="">
            </a>
          </div>
          <div class="col-8">
      ...
      <div class="col-sm-12 col-md-6">
        <div class="row">
          <div class="col-4">
            <img src="../../assets/img/phone-icon.png" class="ml-5 mb-3" width="90"
              height="85" alt="">
          </div>
          <div class="col-8">
            <div class="row mt-2">
