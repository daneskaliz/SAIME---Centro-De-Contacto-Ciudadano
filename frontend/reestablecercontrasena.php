...
<h5 class="text-white text-center py-5 font-weight-bold fontindex">RECUPERAR CONTRASEÑA</h5>
</div>
    ...
    <div class="row justify-content-center">
        <div class="col-10">
          <div class="card card5 text-center bg-light">
            ...
            <div class="col-6">
            <button class="btn btn-sm btn-primary font-weight-bold" type="submit"> <span class="btn-sm text-white mdi mdi-send"></span>ENVIAR</button>
            </div>
            </div>
          </div>
          </div>
