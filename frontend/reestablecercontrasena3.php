    ...
    <div class="row justify-content-center">
        <div class="col-10">
          ...
          <div class="alert alert-info" role="alert">
                ...
                </span>Reestablecer Contraseña: <h6 class="card-subtitle mb-2 text-muted">Podría iniciar sesión en esta cuenta de usuario con la nueva contraseña</h6><span>
              </div>
            ...
            <div class="col-6">
            <button class="btn btn-sm btn-primary font-weight-bold" type="submit"> <span class="btn-sm text-white mdi mdi-send"></span>REESTABLECER</button>
            </div>
            </div>
          </div>
          </div>
