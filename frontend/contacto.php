<?php include('header.php'); ?>
  ...
  <div class="container contenido1 bg-light pb-5">
     <div class="row ml-5">
      <h5 class="shadow-sm p-3 mb-5 bg-white mt-5 rounded">Comuníquese con nosotros. Atenderemos todas sus sugerencias y/o denuncias.</h5>
     </div>
  <!--ICON TWITTER-->
    <div class="row">
      <div class="col-6">
      ...
      <div class="col-sm-12 col-md-6">    
        <div class="row">
          <div class="col-4">    
            <img src="../bootstrap-4.5.0-dist/bootstrap-4.5.0-dist/img/mail.png" class="ml-5 my-4" width="90" height="85" alt="">
          </div>
          <div class="col-8">
            <div class="row mt-5">
      ...
      <div class="col-sm-12 col-md-6">    
        <div class="row">
          ...
          <div class="col-8">
            <div class="row mt-5">
              <span class="font-weight-bold">Centro Virtual de Atención al Ciudadano</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-12 col-md-6">    
        <div class="row">
          <div class="col-4">    
            <img src="../bootstrap-4.5.0-dist/bootstrap-4.5.0-dist/img/phone-icon.png" class="ml-5 mb-3" width="90" height="85" alt="">
          </div>
          <div class="col-8">
            <div class="row mt-2">
